                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.tasks.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('mother_nic') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="mother_nic" id="mother_nic" value="{{ old('mother_nic', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('mother_birthday') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="mother_birthday" id="mother_birthday" value="{{ old('mother_birthday') }}">
                        ...
                        <div class="form-group {{ $errors->has('mother_mobile') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="mother_mobile" id="mother_mobile" value="{{ old('mother_mobile', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('mother_occupation') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="mother_occupation" id="mother_occupation" value="{{ old('mother_occupation', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('mother_address') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="mother_address" id="mother_address" value="{{ old('mother_address', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('father_nic') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="father_nic" id="father_nic" value="{{ old('father_nic', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('father_birthday') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="father_birthday" id="father_birthday" value="{{ old('father_birthday') }}">
                        ...
                        <div class="form-group {{ $errors->has('father_mobile') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="father_mobile" id="father_mobile" value="{{ old('father_mobile', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('father_occupation') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="father_occupation" id="father_occupation" value="{{ old('father_occupation', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('father_address') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="father_address" id="father_address" value="{{ old('father_address', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('baby_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="baby_name" id="baby_name" value="{{ old('baby_name', '') }}">
                        ...
                        <div class="form-group {{ $errors->has('baby_birthday') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control date" type="text" name="baby_birthday" id="baby_birthday" value="{{ old('baby_birthday') }}">
                        ...
                        <div class="form-group {{ $errors->has('follow_update') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control datetime" type="text" name="follow_update" id="follow_update" value="{{ old('follow_update') }}">
